                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $vo['_menu_title']; ?></td>
                            <td><?php echo $vo['menu_url']; ?></td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo url('edit', ['id'=>$vo['menu_id']]); ?>">编辑</a></li>
                                        <li class="divider"></li>
