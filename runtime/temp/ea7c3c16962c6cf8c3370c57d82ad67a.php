                ...
                <form role="form" class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" <?php if($field['menu_pid'] == 0): ?>disabled value=""<?php else: ?>value="<?php echo $field['module']; ?>"<?php endif; ?>  name="module">
                            </div>
                        </div>
                        <div class="form-group">
