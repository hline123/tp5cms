                ...
                <form role="form" class="form-horizontal" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="cname" value="<?php echo $field['cname']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">英文名称：</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?php echo $field['ename']; ?>" name="ename">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="dt_type" class="form-control">
                                    <option <?php if($field['dt_type'] == 1): ?>selected<?php endif; ?> value="1"> 文本框 </option>
                                    <option <?php if($field['dt_type'] == 2): ?>selected<?php endif; ?> value="2"> 单选按钮 </option>
                                    <option <?php if($field['dt_type'] == 3): ?>selected<?php endif; ?> value="3"> 多选按钮 </option>
                                    <option <?php if($field['dt_type'] == 4): ?>selected<?php endif; ?> value="4"> 下拉框 </option>
                                    <option <?php if($field['dt_type'] == 5): ?>selected<?php endif; ?> value="5"> 文本域 </option>
                                    <option <?php if($field['dt_type'] == 6): ?>selected<?php endif; ?> value="6"> 附件 </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="cf_type" class="form-control">
                                    <option <?php if($field['cf_type'] == 1): ?>selected<?php endif; ?> value="1"> 基本信息 </option>
                                    <option <?php if($field['cf_type'] == 2): ?>selected<?php endif; ?> value="2"> 联系方式 </option>
                                    <option <?php if($field['cf_type'] == 3): ?>selected<?php endif; ?> value="3"> SEO设置 </option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="value" cols="30" rows="3" class="form-control"><?php echo $field['value']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">可选值：</label>
                            <div class="col-sm-9">
                                <textarea name="values" cols="30" rows="3" class="form-control"><?php echo $field['values']; ?></textarea>
                            </div>
                        </div>
                    </div>
