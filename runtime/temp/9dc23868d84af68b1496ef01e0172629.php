                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="model_id">
                                        <option <?php if($oldData['model_id'] == 1): ?>selected<?php endif; ?> value="1">选择模型</option>
                                        <option <?php if($oldData['model_id'] == 2): ?>selected<?php endif; ?> value="2">文章模型</option>
                                        <option <?php if($oldData['model_id'] == 3): ?>selected<?php endif; ?> value="3">管理员模型</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
