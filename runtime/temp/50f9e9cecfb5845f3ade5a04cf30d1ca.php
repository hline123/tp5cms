...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('category/index'); ?>"><i class="fa fa-database"></i>模型管理</a></li>
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo $prefix; ?><?php echo $vo['table_name']; ?></td>
                            <td>
                                <?php if($vo['model_status'] == 1): ?>
                                <span class="label label-warning" onclick="changeStatus(this, '<?php echo $vo['model_id']; ?>')">启用</span>
                                <?php else: ?>
                                <span class="label label-danger" onclick="changeStatus(this, '<?php echo $vo['model_id']; ?>')">禁用</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo url('edit',['id'=>$vo['model_id']]); ?>">编辑</a></li>
                                        <li class="divider"></li>
                                        <li><a href="javascript:;" onclick="del(this, '<?php echo $vo['model_id']; ?>')">删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
