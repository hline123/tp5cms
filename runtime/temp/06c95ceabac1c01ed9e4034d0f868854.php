                ...
                <form role="form" class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="" name="module">
                            </div>
                        </div>
                        <div class="form-group">
