                ...
                <form role="form" class="form-horizontal" method="post">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="" name="table_name">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" name="model_status" value="1" checked> 开启
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="model_status" value="0"> 禁用
                                </label>
                            </div>
                        </div>
                    </div>
